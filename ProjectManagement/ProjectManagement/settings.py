...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'rest_framework',
    # Ensure your TaskManagement app is included here.
    'TaskManagement',
]

# This is the final, correct middleware order to resolve all CORS and static file issues.
# The CorsMiddleware must be as high as possible.
MIDDLEWARE = [
...
# Ensure this points to the correct location of your main urls.py file.
...
# Database
# Use dj-database-url to configure your database from a single URL environment variable
