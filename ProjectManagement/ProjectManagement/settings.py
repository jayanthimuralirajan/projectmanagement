...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'rest_framework',
    # Ensure your TaskManagement app is included here. This is crucial!
    'TaskManagement',
]

# This is the correct and standard middleware order for a production Django app with CORS.
MIDDLEWARE = [
